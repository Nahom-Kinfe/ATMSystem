...
/*************  ✨ Windsurf Command ⭐  *************/
    /**
     * Withdraws the given amount from the given user's account.
     * 
     * @param user the user to withdraw from
     * @param amount the amount to withdraw
     * @return true if successful, false if the user does not have sufficient funds
     */
/*******  e7f1ac83-5e3a-4608-849a-f5ff6c7ceb6f  *******/            PreparedStatement checkStmt = conn.prepareStatement(checkQuery);
